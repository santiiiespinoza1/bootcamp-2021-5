package bdd.grupo5.pages;

import bdd.grupo5.bases.SeleniumBase;
...
public class VFHomeTraslados extends SeleniumBase {
    ...
    public  VFHomeTraslados(WebDriver driver){super(driver);}
    // Localizadores
    ...
    public void goToTraslados(){
        goToUrl("https://www.viajesfalabella.cl/traslados/");
    }
